        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              buildSection(s.sectionPhishing, bank.phishingExamples),
              buildSection(s.sectionScams, bank.commonScams),
              buildSection(s.sectionIncidents, bank.recentIncidents),
              buildSection(s.sectionRecommended, bank.recommendedActions),
            ],
          ),
        );
      },
