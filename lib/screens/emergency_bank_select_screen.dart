...
class _EmergencyBankSelectScreenState
    extends State<EmergencyBankSelectScreen> {
  ...
  Future<void> _callPhone(String phone) async {
    final p = phone.trim();
    if (p.isEmpty) return;
    await launchUrl(Uri(scheme: 'tel', path: p), mode: LaunchMode.externalApplication);
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                  phone.trim().isEmpty ? s.bankPhoneNA : s.callBankOfficial,
            ...
            child: FutureBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snap) {
                ...
                return ListView(
                  padding: const EdgeInsets.all(16),
                  children: [
                    _NoticeCard(notice: s.emergencyNotice),
                    const SizedBox(height: 16),

                    TextField(
                      onChanged: (v) => setState(() => _query = v),
                      decoration: InputDecoration(
                        hintText: s.searchBankHintEmergency,
                    ...
                    ...filtered.map((bank) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(s.openOfficialContacts),
